...
target_percent_low  = np.percentile(target_percent_train, 25)
...
model = Sequential([
    layers.LSTM(24, input_shape=(None,train_x.shape[-1]) ,return_sequences=True),
    layers.LSTM(24, input_shape=(None,train_x.shape[-1])),
